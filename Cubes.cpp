...
int main()
{
    ...
    cout << " Из этого бруска можно изготовить " << result << correctText(x, y, z) << endl;    // Произведение кол-ва кубиков по сторонам выводим как кол-во получившихся кубиков
    if (cbrtf(result) >= 2) {                                                                                 // Если корень кубический из кол-ва кубиков больше или равен 2
        cout << " Из них можно составить набор из " << powf(floorf(cbrtf(result)), 3) << " кубиков." << endl;    // Вычисляем корень кубический из кол-ва кубиков, округляем результат в меньшую сторону и возводим в куб
